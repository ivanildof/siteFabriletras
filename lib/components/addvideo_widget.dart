...
import '/components/listade_videos_widget.dart';
...
import 'addvideo_model.dart';
export 'addvideo_model.dart';
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent('ADDVIDEO_COMP_Icon_m1myfq8j_ON_TAP');
                  ...
                  child: Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'ADDVIDEO_COMP_SUBIR_VDEO_BTN_ON_TAP');
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'ADDVIDEO_COMP_U_R_L_VDEO_BTN_ON_TAP');
                          logFirebaseEvent('Button_update_component_state');
                          _model.urlvideo = !_model.urlvideo;
                          setState(() {});
                        },
                        text: 'URL Vídeo',
                        icon: const FaIcon(
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'ADDVIDEO_VDEOS_ADICIONADOS_BTN_ON_TAP');
                            ...
                            builder: (context) {
                              return WebViewAware(
                                child: Padding(
                                  ...
                                  child: const ListadeVideosWidget(),
                                ),
                              );
                            },
                ...
                Padding(
                  ...
                  child: FlutterFlowDropDown<String>(
                    controller: _model.dropDownValueController ??=
                      ...
                      _model.dropDownValue ??= 'Letra de Led',
                    ),
                    options: const [
                      'Letra de Led',
                      'Letra Latão',
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'ADDVIDEO_COMP_ADICIONAR_VDEO_BTN_ON_TAP');
                      logFirebaseEvent('Button_backend_call');

                      await VideosLetreirosRecord.collection
                          .doc()
                          .set(createVideosLetreirosRecordData(
                            ...
                            videoYoutube: _model.urlTextController.text,
                          ));
                    ...
                    text: 'Adicionar Vídeo em ${_model.dropDownValue}',
                    options: FFButtonOptions(
                      height: 40.0,
                      padding:
