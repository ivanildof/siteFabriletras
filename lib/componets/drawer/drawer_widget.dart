...
class _DrawerWidgetState extends State<DrawerWidget> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('DRAWER_COMP_Container_usarw1a0_ON_TAP');
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('DRAWER_COMP_produtos_ON_TAP');
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('DRAWER_COMP_orcament_ON_TAP');
                        logFirebaseEvent('orcament_navigate_to');
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('DRAWER_COMP_revendedore_ON_TAP');
                        logFirebaseEvent('revendedore_navigate_to');
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('DRAWER_COMP_visita_ON_TAP');
                        logFirebaseEvent('visita_navigate_to');
                  ...
                  children: [
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent('DRAWER_COMP_sair_ON_TAP');
                            logFirebaseEvent('sair_navigate_to');
