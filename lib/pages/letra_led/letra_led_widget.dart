                                        ...
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  12.0, 0.0, 12.0, 0.0),
                                          child: Text(
                                            'A \"letra caixa com LED\" é um tipo de letreiro bastante popular em fachadas comerciais, interiores de lojas e em sinalização corporativa, sendo muito eficaz para chamar a atenção devido ao seu visual moderno e iluminado. Aqui estão os principais aspectos desse tipo de letra: ### Características da Letra Caixa com LED: \n\n1. Design 3D: As letras caixa são em relevo e possuem uma estrutura tridimensional que dá profundidade e destaque. \n\n2. Iluminação com LED: A iluminação interna por LED destaca as letras, mesmo à noite. Os LEDs podem ser brancos ou coloridos, dependendo da necessidade. \n\n3. Materiais Comuns: Geralmente são feitas de aço inox, alumínio, acrílico, PVC ou MDF, dependendo do uso interno ou externo e da durabilidade necessária.\n\n 4. Instalação: Podem ser instaladas em fachadas, paredes internas ou até suspensas. A fixação é geralmente feita com espaçadores, para um efeito flutuante. \n\n5. Estilo e Customização: É possível personalizar o tamanho, a fonte e a cor das letras para combinar com a identidade visual da marca. \n\n',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily:
