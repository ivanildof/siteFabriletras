                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 0.0, 0.0, 10.0),
                                        child: Text(
                                          'A letra de aço escovado é um tipo de letreiro bastante utilizado em fachadas comerciais, placas de sinalização, escritórios e interiores. Esse tipo de letra é feito de aço inoxidável que passa por um processo de escovação, conferindo uma aparência fosca e elegante.\n\nMétodo\nAcabamento: Superfície escovada, que dá um aspecto fosco e sofisticado.\nResistência: Resistente à corrosão, clima e desgaste, sendo ideal para ambientes internos e externos.\nInstalação: Pode ser fixada diretamente na parede com pinos de fixação, fita dupla face de alta resistência ou colada.\nPor\nDurabilidade: Resistente ao tempo e à corrosão.\nEstética: Aparência moderna e limpa, valorizando o ambiente.\nManutenção: Fácil de limpar, com necessidade apenas de um pano úmido e sabão neutro.\nAplicações Comuns:\nFachadas Comerciais: Para destacar o nome da empresa.\nPlacas de Sinalização: Em áreas corporativas, hotéis e hospitais.\nDecoração Interna: Logotipos e nomes de empresas em recepções e escritórios.\nEsse tipo de letreiro é uma escolha popular para quem busca um visual contemporâneo e durável para comunicação visual.',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily:
